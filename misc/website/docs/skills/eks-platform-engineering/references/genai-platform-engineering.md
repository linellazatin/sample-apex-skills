---
title: "GenAI-Assisted Platform Engineering"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-platform-engineering/references/genai-platform-engineering.md
format: md
---

:::info[Source]
This page is generated from [skills/eks-platform-engineering/references/genai-platform-engineering.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-platform-engineering/references/genai-platform-engineering.md). Edit the source, not this page.
:::
