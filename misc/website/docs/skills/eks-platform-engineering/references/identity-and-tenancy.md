...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-platform-engineering/references/identity-and-tenancy.md
format: md
---

:::info[Source]
This page is generated from [skills/eks-platform-engineering/references/identity-and-tenancy.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-platform-engineering/references/identity-and-tenancy.md). Edit the source, not this page.
:::
